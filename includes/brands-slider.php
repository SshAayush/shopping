<div id="brands-carousel" class="logo-slider wow fadeInUp">
		...
		<div class="logo-slider-inner">	
			...
			<div class="item">
					<a href="#" class="image">
						<img data-echo="brandsimage/apple.png" src="assets/images/blank.gif" alt="">
					</a>	
				</div>
				<div class="item">
					<a href="#" class="image">
				...
				<div class="item">
					<a href="#" class="image">
						<img data-echo="brandsimage/adidas.png" src="assets/images/blank.gif" alt="">
					</a>	
				</div>
				...
				<div class="item">
					<a href="#" class="image">
						<img data-echo="brandsimage/nike.png" src="assets/images/blank.gif" alt="">
					</a>	
				</div>
<div class="item">
					<a href="#" class="image">
				...
				<div class="item">
					<a href="#" class="image">
						<img data-echo="brandsimage/Hitachi.jpg" src="assets/images/blank.gif" alt="">
					</a>	
				</div>
				<div class="item">
					<a href="#" class="image">
						<img data-echo="brandsimage/Nikon.jpg" src="assets/images/blank.gif" alt="">
					</a>	
				</div>
